...
# coding: utf-8
"""
Training script for LogisticRegression model.

Usage: python 02_train_logistic.py s 0 24 [data_dir]
  s = summer, w = winter; 0 24 = start/end repetition range
...
print('Arguments count:', len(sys.argv), 'arguments.')
...
class LogisticRegression(nn.Module):
    def __init__(self):
        ...
        self.linear = nn.Linear(input_dim * input_w * input_h, num_classes)
...
mymodelname = "LogisticRegression"
    ...
    for x in range(1, 3):
        ...
        for i in [1, 0.75, 0.5, 0.25]:
            ...
            for j in [1, 2, 3, 4, 5]:
                ...
                net_epochs = 100
                train(mymodel(), mymodelname + "-" + str(n), 0.001, 0.999, 0.001, 0)